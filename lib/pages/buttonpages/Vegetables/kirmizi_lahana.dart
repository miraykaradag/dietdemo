...
class KirmiziLahana extends StatefulWidget {
  const KirmiziLahana({super.key});

  @override
  State<KirmiziLahana> createState() => _KirmiziLahanaState();
}

class _KirmiziLahanaState extends State<KirmiziLahana> {
  @override
